...
public class GasMeter_records extends RealmObject {
    //Fields
    ...
    //Constructors
    public GasMeter_records(){}

    public GasMeter_records(Long currentreading, String comment ){
        this.current_reading = currentreading;
        this.comment = comment;
        this.record_date = new Date();
    }

    public GasMeter_records(Long currentreading){
        this.current_reading = currentreading;
        this.comment = "";
        this.record_date = new Date();
    }
    ...
    //Methods
    public void ComputeConsumption(GasMeter_records oldrecord){
